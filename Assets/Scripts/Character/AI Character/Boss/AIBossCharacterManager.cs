...
namespace SG
{
    public class AIBossCharacterManager : AICharacterManager
    {
        ...
        //When this ai is spawned, check our save file
        ...
        public override void OnNetworkSpawn()
        {
            ...
            //So if you join when the fight is already active, you will get a hp bar.
        ...
        {
            PlayerUIManager.instance.playerUIPopUpManager.SendBossDefeatedPopUp("Defeated Boss");
